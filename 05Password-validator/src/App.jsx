...
function App() {
  ...
  const validate = (e) => {
    ...
    if(validator.isStrongPassword(value,{
        ...
        setErrorMessage("❌ Weak Password: Ensure it has 8+ chars, 1 uppercase, 1 number, 1 symbol."); 
    } 
  }
      ...
      <div className="max-w-[720px] mx-auto">
        <div className="relative flex flex-col text-gray-700 bg-white shadow-xl w-96  rounded-xl bg-clip-border">
          <div className="flex flex-col gap-4 p-6">
            ...
            <p
              className={`flex justify-center mt-6 font-sans text-sm antialiased  leading-normal `}
            >
